...
var ClienteService = /** @class */ (function () {
    function ClienteService(db) {
        this.clientesCollection = db.collection('clientes');
        this.clientes = this.clientesCollection.snapshotChanges().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["map"])(function (actions) {
    ...
    ClienteService.prototype.getCliente = function (id) {
        return this.clientesCollection.doc(id).valueChanges();
    };
    ClienteService.prototype.updateCliente = function (todo, id) {
        return this.clientesCollection.doc(id).update(todo);
    };
    ClienteService.prototype.addCliente = function (todo) {
        return this.clientesCollection.add(todo);
    };
    ClienteService.prototype.removeCliente = function (id) {
